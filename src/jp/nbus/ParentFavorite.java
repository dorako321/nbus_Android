...
public class ParentFavorite extends ActivityGroup{
    ...
    public void showChild_bookmark() {
        ...
        Intent intent = new Intent(ParentFavorite.this, FavoriteForm.class);
    ...
    public void showChild_edit() {
    	state = 1;
        container2.removeAllViews();
        Intent intent = new Intent(ParentFavorite.this, FavoriteEdit.class);
