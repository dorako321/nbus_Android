...
public class Child1_search extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_search.setWidth((int)(Parent1.disp_width*0.8));
        btn_search.setHeight(Parent1.disp_height/11);
        ...
        btn_search.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				}else if(TextUtils.isEmpty(Parent1.getoff_name)){	//降車停留所が未入力
					Toast.makeText(getApplicationContext(), "降車停留所を入力してください。", Toast.LENGTH_SHORT).show();
				}else{	//どっちも入力してる
					Parent1.route = Parent1.geton_name + "→" + Parent1.getoff_name;
					//ソフトウェアキーボードを閉じる
                ...
                try {
                	...
                	for(int i=0; i<length; i++){
                		...
                		try{
                			...
                			Parent1.busstops[i] = new BusStop(stop.getInt("co"),
