...
public class ParentSmartCard extends ActivityGroup{
    ...
    public void showChild_list() {
        ...
        Intent intent = new Intent(ParentSmartCard.this, SmartCardList.class);
    ...
    public final void showChild_detail(String idm) {
    	state = 1;
        container3.removeAllViews();
        Intent intent = new Intent(getApplicationContext(), SmartCardDtail.class);
        intent.putExtra("idm", idm);
        SmartCardDtail.IDM_STATIC =idm;
       // setIntent(intent);
